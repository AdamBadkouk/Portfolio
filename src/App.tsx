...
function App() {
  ...
  const projects = [
    {
      title: "WoodExpert",
      description:
        "WoodExpert is a wood design and manufacturing company that creates custom furniture and decorative pieces.",
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-300 ${isDarkMode ? "bg-gradient-to-br from-[#161925] via-[#24334C] to-[#371D33]" : "bg-gradient-to-br from-blue-100 via-violet-200 to-indigo-100"}`}
    >
      {/* Navbar */}
      <nav
        className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 backdrop-blur-md shadow-lg rounded-md px-3 sm:px-8 py-2 sm:py-3 transition-colors duration-300 ${isDarkMode ? "bg-[#24334C]/30" : "bg-white/20"}`}
      >
        <div className="flex items-center justify-between">
          ...
          <div className="hidden min-[355px]:flex items-center space-x-2 sm:space-x-8">
            ...
            <div
              className={`w-px h-4 sm:h-6 mx-1 sm:mx-2 ${isDarkMode ? "bg-[#1F4964]/50" : "bg-gray-400"}`}
            ></div>
            <button
      ...
      {isMobileMenuOpen && (
        <div
          className="min-[355px]:hidden fixed inset-0 z-40 bg-black/50 backdrop-blur-sm"
      ...
      >
        <div className="text-center max-w-4xl mx-auto">
          <div className="animate-fade-in">
            <h1
              className="text-6xl sm:text-7xl lg:text-8xl font-bold mb-6 animate-title-entrance"
              style={{ animationDelay: "0.2s" }}
            >
              <span
                className={`font-sans ${isDarkMode ? "text-white" : "text-gray-800"}`}
              >
                Adam Badkouk
              </span>
            </h1>
            <p
              className={`text-xl sm:text-2xl lg:text-3xl mb-12 font-light animate-title-entrance ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
              style={{ animationDelay: "0.2s" }}
            >
              Full-Stack Developer | MERN Stack & Next.js | Laravel
            </p>
            <div
              className="flex flex-col sm:flex-row gap-6 justify-center items-center max-w-4xl mx-auto animate-slide-up"
      ...
      >
        <div
          className={`max-w-4xl mx-auto transition-all duration-1000 ${visibleSections.has("about") ? "animate-section-slide-in" : "opacity-0 translate-y-10"}`}
        >
          <div className="text-center mb-16">
            <h2
              className={`text-4xl sm:text-5xl font-bold mb-6 ${isDarkMode ? "text-white" : "text-black"}`}
            >
              About Me
            </h2>
            <p
          ...
          <div
            className={`backdrop-blur-md rounded-lg p-8 shadow-lg ${
              isDarkMode ? "bg-[#24334C]/40" : "bg-white/20"
            }`}
          >
            <div
              className={`prose prose-lg max-w-none ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
            >
              <blockquote
      ...
      >
        <div
          className={`max-w-6xl mx-auto transition-all duration-1000 ${visibleSections.has("skills") ? "animate-section-slide-in" : "opacity-0 translate-y-10"}`}
        >
          <div className="text-center mb-16">
            <h2
              className={`text-4xl sm:text-5xl font-bold mb-6 ${isDarkMode ? "text-white" : "text-black"}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div
              className={`backdrop-blur-md rounded-lg p-6 shadow-lg h-56 ${
                isDarkMode ? "bg-[#24334C]/40" : "bg-white/20"
              }`}
            >
              <h3
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {["JavaScript", "TypeScript", "PHP", "Python", "C++"].map(
                  (skill, index) => (
                    <span
                      key={index}
                      className={`px-3 py-1 text-sm rounded-md ${isDarkMode ? "text-gray-300 bg-gray-700/30" : "text-gray-700 bg-gray-200/30"}`}
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {["Windows", "Linux (Debian & Arch Based Distros)"].map(
                  (os, index) => (
                    <span
                      key={index}
                      className={`px-3 py-1 text-sm rounded-md ${isDarkMode ? "text-gray-300 bg-gray-700/30" : "text-gray-700 bg-gray-200/30"}`}
            ...
            {/* Cybersecurity */}
            <div
              className={`backdrop-blur-md rounded-lg p-6 shadow-lg min-h-56 ${
                isDarkMode ? "bg-[#24334C]/40" : "bg-white/20"
              }`}
            >
              <h3
            ...
            <div
              className={`backdrop-blur-md rounded-lg p-6 shadow-lg min-h-56 lg:col-span-3 ${
                isDarkMode ? "bg-[#24334C]/40" : "bg-white/20"
              }`}
            >
              <h3
      ...
      >
        <div
          className={`max-w-7xl mx-auto transition-all duration-1000 ${visibleSections.has("projects") ? "animate-section-slide-in" : "opacity-0 translate-y-10"}`}
        >
          <div className="text-center mb-16">
            <h2
              className={`text-4xl sm:text-5xl font-bold mb-6 ${isDarkMode ? "text-white" : "text-black"}`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              ...
              >
                <div className="mb-6">
                  <h3
                    className={`text-2xl font-bold mb-3 transition-colors duration-300 ${isDarkMode ? "text-white" : "text-black"}`}
                  >
                    {project.title}
                  </h3>
                  <p
                    className={`leading-relaxed mb-4 ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}
                  >
                    {project.description}
                  </p>
                  <div className="flex flex-wrap gap-2 mb-6">
      ...
      >
        <div
          className={`max-w-4xl mx-auto transition-all duration-1000 ${visibleSections.has("contact") ? "animate-section-slide-in" : "opacity-0 translate-y-10"}`}
        >
          <div className="text-center mb-16">
            <h2
              className={`text-4xl sm:text-5xl font-bold mb-6 ${isDarkMode ? "text-white" : "text-black"}`}
          ...
          <div
            className={`backdrop-blur-md rounded-lg p-8 shadow-lg max-w-md mx-auto ${
              isDarkMode ? "bg-[#24334C]/40" : "bg-white/20"
            }`}
          >
            <h3
              className={`text-2xl font-bold mb-8 text-center ${isDarkMode ? "text-white" : "text-black"}`}
            >
              Connect With Me
            </h3>
            <div className="flex flex-col space-y-4 max-w-xs mx-auto">
              ...
              >
                <svg
                  className={`w-6 h-6 mr-4 ${isDarkMode ? "text-white" : "text-gray-700"}`}
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
